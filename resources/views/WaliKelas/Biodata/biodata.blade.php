...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function detail() {
            ...
            $.ajax({
                url: 'http://localhost:8000/wali_kelas/biodata/detail',
                type: 'GET',
        ...
        function formEdit(id) {
            ...
            $.ajax({
                url: 'http://localhost:8000/wali_kelas/biodata/' + id + '/edit',
                type: 'GET',
        ...
        function update(id) {
            ...
            $.ajax({
                url: 'http://localhost:8000/wali_kelas/biodata/' + id + '/update',
                type: 'put',
                headers: {
