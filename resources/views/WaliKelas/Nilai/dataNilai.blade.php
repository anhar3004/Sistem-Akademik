        ...
        <script type="text/javascript">
            ...
            function dataTable() {
                $('#table').DataTable({
                    ...
                    "ajax": {
                        "url": "http://localhost:8000/wali_kelas/nilai/dataTable",
                        "dataSrc": ""
                    },
                    "columns": [{
                            data: null,
            ...
            function formTambahPenilaianHarian(id) {
                ...
                $.ajax({
                    url: 'http://localhost:8000/wali_kelas/nilai/' + id + '/formTambahNilaiPenilaianHarian',
                    type: 'GET',
            ...
            function dataTablePenilaianHarian(mapel, semester) {
                ...
                $('#tablePenilaianHarian').DataTable({
                    ...
                    "ajax": {
                        "url": "http://localhost:8000/wali_kelas/nilai/" + mapel + "/" + semester +
                            "/dataTablePenilaianHarian",
                        "dataSrc": ""
                    },
                    "columns": [{
            ...
            function createPenilaianHarian(id, kelas) {
                ...
                $.ajax({
                    url: 'http://localhost:8000/wali_kelas/nilai/createPenilaianHarian',
                    type: 'post',
                    headers: {
            ...
            function editPenilaianHarian(id) {
                ...
                $.ajax({
                    url: 'http://localhost:8000/wali_kelas/nilai/' + id + '/editPenilaianHarian',
                    type: 'GET',
            ...
            function updatePenilaianHarian(id, id_mapel, kelas) {
                ...
                $.ajax({
                    url: 'http://localhost:8000/wali_kelas/nilai/' + id + '/updatePenilaianHarian',
                    type: 'put',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function hapusPenilaianHarian(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: 'http://localhost:8000/wali_kelas/nilai/' + id + '/deletePenilaianHarian',
                            type: 'GET',
                            success: function(data) {
                                $.each(data, function(key, value) {
            ...
            function formTambahNilaiPengetahuan(id) {
                ...
                $.ajax({
                    url: 'http://localhost:8000/wali_kelas/nilai/' + id + '/formTambahNilaiPengetahuan',
                    type: 'GET',
            ...
            function createPengetahuan(id, kelas) {
                ...
                $.ajax({
                    url: 'http://localhost:8000/wali_kelas/nilai/createPengetahuan',
                    type: 'post',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function editPengetahuan(id) {
                ...
                $.ajax({
                    url: 'http://localhost:8000/wali_kelas/nilai/' + id + '/editPengetahuan',
                    type: 'GET',
            ...
            function updatePengetahuan(id, id_mapel, kelas) {
                ...
                $.ajax({
                    url: 'http://localhost:8000/wali_kelas/nilai/' + id + '/updatePengetahuan',
                    type: 'put',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function hapusPengetahuan(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: 'http://localhost:8000/wali_kelas/nilai/' + id + '/deletePengetahuan',
                            type: 'GET',
                            success: function(data) {
                                $.each(data, function(key, value) {
                                    id_mapel = data[key].id_mapel;
            ...
            function formTambahNilaiKeterampilan(id) {
                ...
                $.ajax({
                    url: 'http://localhost:8000/wali_kelas/nilai/' + id + '/formTambahNilaiKeterampilan',
                    type: 'GET',
            ...
            function createKeterampilan(id,kelas) {
                ...
                $.ajax({
                    url: 'http://localhost:8000/wali_kelas/nilai/createKeterampilan',
                    type: 'post',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function editKeterampilan(id) {
                ...
                $.ajax({
                    url: 'http://localhost:8000/wali_kelas/nilai/' + id + '/editKeterampilan',
                    type: 'GET',
            ...
            function updateKeterampilan(id, id_mapel, kelas) {
                ...
                $.ajax({
                    url: 'http://localhost:8000/wali_kelas/nilai/' + id + '/updateKeterampilan',
                    type: 'put',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
            ...
            function hapusKeterampilan(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: 'http://localhost:8000/wali_kelas/nilai/' + id + '/deleteKeterampilan',
                            type: 'GET',
                            success: function(data) {
                                $.each(data, function(key, value) {
                                    id_mapel = data[key].id_mapel;
