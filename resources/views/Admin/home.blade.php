            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-1">
                        <div class="card-body">
                            <h3 class="card-title text-white">Total Siswa</h3>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-2">
                        <div class="card-body">
                            <h3 class="card-title text-white">Total Guru</h3>
                            <div class="d-inline-block">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-3">
                        <div class="card-body">
                            <h3 class="card-title text-white">Total Kelas</h3>
                            <div class="d-inline-block">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-4">
                        <div class="card-body">
                            <h3 class="card-title text-white">Total Pelajaran</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white">89</h2>
                                <p class="text-white mb-0">2019-2020</p>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered zero-configuration table-hover text-center">
                                    <thead>
                                        <tr>
                                            <th>NIS</th>
                                            <th>Nama</th>
